...
const quiz = [
  {
    ...
    question: 'lam',
    image: '',
    image_alt: '',    answers: [ 'アンディ', 'willson', 'かつあき', 'たけお'],
    correct: 'かつあき'
  }
];
...
// const $congrat2 = $doc.getElementById("congratulation2");
...
//   $congrat2.href = "https://okada60.wixsite.com/my-site";
//   $congrat2.textContent = "correct";
// }
// function change_fail2(){
//   $congrat2.href = "";
//   $congrat2.textContent = "fail";
// }

function change_correct_timeover(){
  $congrat_timeover.href = "/quiz_1_correct";
  $congrat_timeover.textContent = "correct";
}
function change_fail_timeover(){
  $congrat_timeover.href = "/quiz_1_fail";
